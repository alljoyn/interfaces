...
| 16    | The entity of interest was not found                   			|
  ...
  * **lampParameters** --- key value pairs --- the Lamp Parameters. The keys are the property names 
                                               in the [LampParameters interface](LampParameters-v1.xml) interface.
...
Input arguments:
  ...
  * **lampID** --- string --- the Lamp ID.
  * **lampParameterFieldName** --- string --- the name of the Lamp Parameter field. This should be one of the parameter names in the [LampParameters interface](LampParameters-v1.xml) interface.
...
Input arguments:
  ...
  * **lampID** --- string --- the Lamp ID.
  * **lampStateFieldName** --- string --- the name of the Lamp State field. This should be one of the parameter names in the [LampState interface](LampState-v1.xml) interface.
