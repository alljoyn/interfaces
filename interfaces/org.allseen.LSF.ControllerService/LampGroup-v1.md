...
Clients to create, update, delete, lookup and apply LampGroups on Lamps.
...
Input arguments:
  ...
  * **language** --- string --- the language associated with the LampGroup Name.
...
| 19    | The last LSF response code                                         		|
  ...
  * **lampGroupID** --- string --- the LampGroup ID.
  * **language** --- string --- the language associated with the LampGroup Name.
  * **lampGroupName** --- string --- the name of the LampGroup. 
