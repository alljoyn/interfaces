...
Clients to create, update, delete, lookup and control the state of LampGroups.
...
Input arguments:
  ...
  * **lampGroupName** --- string --- the LampGroup Name.
  * **language** --- string --- the language tag associated with the LampGroup Name.
...
Input arguments:
  ...
  * **lampGroupID** --- string --- the LampGroup ID.
  * **lampState** --- key value pairs --- the LampGroup State.
...
This method allows the LSF Controller Clients to apply Pulse Effect on a LampGroup. 
