...
Clients to create, update, delete, lookup and apply Scene Elements.
...
The Controller Service can store only a maximum of 100 Scene Elements or until the size of the 
persisted Scene Elements file reaches 127KB whichever occurs first. If the user attempts to create more 
than 100 Scene Elements, "no slot for new entry" is returned as the responseCode or if the user tries to
create a new Scene Element after the size of the Scene Elements file reaches 127KB, "Not enough resources" is
