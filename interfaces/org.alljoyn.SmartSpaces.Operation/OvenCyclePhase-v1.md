...
This interface provides a capability to control and monitor the phase of the
operational cycle of an Oven device: it can be simple oven or complex device
