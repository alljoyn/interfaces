...
Output arguments:
  ...
  * **checksumAndTimestamp** --- struct[uint32, uint32, uint64] --- Array of structure containing lighting data type and the corresponding checksum and timestamp in milliseconds (representing monotonic time) of when it was last updated
...
| 13            | Scene v2                                               		        |
  ...
  * **timestamp** --- uint64 --- the timestamp in milliseconds (representing monotonic time) of last update of the lighting data.

#### Overthrow () -> (success)

This method allows the any entity to overthrow the current leader. 
