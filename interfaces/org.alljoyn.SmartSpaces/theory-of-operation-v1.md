...
| org.alljoyn.SmartSpaces.DeviceTypeDescription| yes       | yes       | no        | a(uo)    | Information that identifies the HAE device types of implemented bus objects |
...
The DeviceTypeDescription is an array of tuples, each tuple consists of HAE device
...
the following values will be signaled as DeviceTypeDescription respectively.
  ...
  * DeviceTypeDescription = { <0, "/HAE">, <2, "/HAE/Alpha">, <3, "/HAE/Beta">, <4, "/HAE/Gamma"> }
