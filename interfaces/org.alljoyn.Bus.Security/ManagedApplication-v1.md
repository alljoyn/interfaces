...
Reset() method call is not required.  The Config.FactoryReset() call in fact
clears the keystore, so this Reset() call is not required in that scenario.
...
Input arguments:
  ...
  * **certificateChain** --- array of Certificate --- the identity certificate
  chain
  * **manifest** --- array of Rule --- the application manifest
...
Errors raised by this method:
  ...
  * org.alljoyn.Bus.ER_PERMISSION_DENIED --- Error raised when the caller does
not have permission.
  * org.alljoyn.Bus.ER_POLICY_NOT_NEWER --- Error raised when the new policy
...
Input arguments:
  ...
  * **certChain** --- array of Certificate --- the membership certificate chain.
...
Errors raised by this method:
  ...
  * org.alljoyn.Bus.ER_PERMISSION_DENIED --- Error raised when the caller does
not have permission.
  * org.alljoyn.Bus.ER_DUPLICATE_CERTIFICATE --- Error raised when the
  membership certificate is already installed.
  * org.alljoyn.Bus.ER_INVALID_CERTIFICATE --- Error raised when the membership
...
Errors raised by this method:
  ...
  * org.alljoyn.Bus.ER_PERMISSION_DENIED --- Error raised when the caller does
not have permission.
  * org.alljoyn.Bus.ER_CERTIFICATE_NOT_FOUND --- Error raised when the
...
| WITH_MEMBESHIP             | The public key of the security group authority |

  * **groupID** --- byteArray(16)--- the security group ID.  This field is
