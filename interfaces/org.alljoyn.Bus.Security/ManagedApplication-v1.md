...
Errors raised by this method:
  ...
  * org.alljoyn.Bus.ER_PERMISSION_DENIED --- Error raised when the caller does
  * org.alljoyn.Bus.ER_INSTALLING_OLDER_POLICY --- Error raised when the new
  policy has smaller version number than the existing policy.
...
Errors raised by this method:
  ...
  * org.alljoyn.Bus.ER_PERMISSION_DENIED --- Error raised when the caller does
  * org.alljoyn.Bus.ER_DUPLICATE_CERTIFICATE --- Error raised when the membership certificate is already installed.
...
| org.alljoyn.Bus.ER_CERTIFICATE_NOT_FOUND   | Certificate not found     |
| org.alljoyn.Bus.ER_INSTALLING_OLDER_POLICY | Installing older policy   |
| org.alljoyn.Bus.ER_DUPLICATE_CERTIFICATE   | Duplicate certificate     |
| org.alljoyn.Bus.ER_INVALID_CERTIFICATE     | Invalid certificate       |
